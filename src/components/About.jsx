...
function About({ isLightMode }) {
    ...
    return (
        <section className={!isLightMode ? "about-me-dark about-me" : "about-me"} id="about-me">
            <Container className="about-me-container">
                <Row>
                    <Col className="about-me-content" lg={6} data-aos="fade-right" data-aos-duration="1000">
                        <h3 className="about-me-title">About Me</h3>
                        <p className={!isLightMode ? "text-dark" : null}>Ciao, sono Francesco Merighi, un <span>WEB DEVELOPER</span> e <span>UI/UX DESIGNER</span>! <br></br>
                             ...
                             portandomi ad imparare ad utilizzare sia tecnologie <span>FRONT-END</span> che <span>BACK-END</span>. <br></br><br></br>
                             La mia passione per la <span>PROGRAMMAZIONE</span> e il <span>DESIGN MODERNO (UI/UX)</span> mi ha portato a
                        ...
                        <div className="cv-download-container">
                            ...
                            {isChoiceShowed ? 
                                <div className={!isLightMode ? "choice-container-dark choice-container" : "choice-container"}>
