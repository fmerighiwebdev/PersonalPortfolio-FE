...
function Hero({ isLightMode }) {
  return (
    <main
      className={!isLightMode ? "hero-dark hero-section" : "hero-section"}
      id="hero"
    >
      <Container className="hero-container">
        <Row>
          <Col className="hero-content" lg={6}>
            <h1
              className={!isLightMode ? "hero-title text-dark" : "hero-title"}
            >
              Ciao, <br></br> sono <span>Francesco Merighi</span>
            </h1>
            <div
              className="hero-links"
              style={
                !isLightMode ? { borderTop: "2px solid rgb(70, 70, 70)" } : null
              }
            >
              <div className="hero-social">
                ...
                <a
                  ...
                  href="https://github.com/francescomerighi1202"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  ...
                  href="https://www.instagram.com/f.merighi_/"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <div className="hero-contact">
                <a className="contact-me-link" href="#contacts">
                  Contattami
                </a>
              </div>
            </div>
      ...
      <div className="down-arrow-container">
        <a href="#about-me">
          <img
            ...
            src={!isLightMode ? downArrowDark : downArrow}
            alt="Down arrow"
          />
        </a>
      </div>
